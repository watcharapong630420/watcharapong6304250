                ...
                <v-toolbar flat height="80">
                  ...
                  <v-dialog v-model="dialog" max-width="800px">
                    ...
                    <v-card class="card-shadow">
                            ...
                            <v-row>
                              <v-col cols="12" class="col-md-4 col-sm-12">
                                <v-text-field
                                  ...
                                  :counter="10"
                                  :rules="bmiRules"
                                  label="My Expentiture-income History"
                                  type="number"
                                  required
                                ></v-text-field>
                              </v-col>
                                ...
                                >
                                  ...
                                  >
                                    ...
                                    <v-btn
                                      ...
                                      color="primary"
                                      @click="
                                        $refs.dialog.save(editedItem.date)
                                      "
                                    >
                                      OK
                                    </v-btn>
                      ...
                      <v-card-actions
                        class="card-padding d-flex justify-center"
                      >
                  ...
                  <v-dialog v-model="dialogDelete" max-width="500px">
                    <v-card class="card-shadow card-padding">
                      ...
                      <v-card-actions class="pb-0">
                        <v-spacer></v-spacer>
                        <v-btn @click="closeDelete" color="yellow"
                          >Cancel</v-btn
                        >

                        <v-btn
                          @click="deleteItemConfirm(itemSelected)"
                          color="error"
                          >Ok</v-btn
                        >
                        <v-spacer></v-spacer>
